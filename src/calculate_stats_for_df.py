...
def calculate_stats_for_df(df):
    ...
    # Wallet targetted
    wallet_targetted_df = df[df["target_address"].str.startswith("tz")]


    # Contract targetted
    contract_targetted_df = df[df["target_address"].str.startswith("KT")]
    ...
    stats = {
        ...
        "wallet_targetted_transactions": len(wallet_targetted_df),
        "contract_targetted_transactions": len(contract_targetted_df),
